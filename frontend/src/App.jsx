      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        {session && (
          <div className="flex items-center gap-4 text-sm font-medium">
            <Link to="/dashboard" className="text-gray-600 hover:text-primary-600">History</Link>
            <button onClick={signOut} className="text-gray-600 hover:text-red-600">Sign Out</button>
          </div>
        )}
      </div>
    </header>
